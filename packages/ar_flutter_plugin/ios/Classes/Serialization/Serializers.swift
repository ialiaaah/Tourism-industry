...
func serializeAnchor(anchor: ARAnchor, anchorNode: SCNNode?, ganchor: AnyObject?, name: String?) -> Dictionary<String, Any?> {
    var serializedAnchor = Dictionary<String, Any?>()
    serializedAnchor["type"] = 0
    serializedAnchor["name"] = name
    serializedAnchor["cloudanchorid"] = nil
