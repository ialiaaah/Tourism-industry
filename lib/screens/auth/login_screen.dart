  ...
  Future<void> _emailLogin() async {
    ...
    try {
      await Provider.of<AuthService>(context, listen: false)
          .signInWithEmail(email: _emailCtrl.text, password: _pwCtrl.text, roleOverride: _role);
      if (mounted) _toHome();
    } catch (e) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        const Icon(Icons.account_balance_rounded, color: Color(0xFFDFAF58), size: 22),
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 10),
                          child: Text('✕', style: GoogleFonts.inter(color: Colors.white24, fontSize: 16)),
                        ),
                        const Icon(Icons.account_balance_rounded, color: Color(0xFFB41E2D), size: 22),
                      ],
                    ),
                    const SizedBox(height: 10),
                    Text('CulturaX',
                        style: GoogleFonts.playfairDisplay(
                            color: _gold, fontSize: 44, fontWeight: FontWeight.bold, letterSpacing: 3)),
                    const SizedBox(height: 6),
                    Text('A Smart Cultural Ecosystem Connecting\nHeritage, Tourism, and Global Conferences',
                        textAlign: TextAlign.center,
                        style: GoogleFonts.inter(color: Colors.white38, fontSize: 10, height: 1.5)),
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        _roleTab('Attendee', Icons.badge_rounded, UserRole.tourist),
                        _roleTab('Organizer', Icons.manage_accounts_rounded, UserRole.guide),
                      ]),
                    ),
                    const SizedBox(height: 20),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: Text('Continue with Google', style: GoogleFonts.inter(color: Colors.white, fontSize: 14)),
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text("Don't have an account?", style: GoogleFonts.inter(color: Colors.white54, fontSize: 13)),
                      TextButton(
                        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SignupScreen())),
                        child: Text('Register', style: GoogleFonts.inter(color: _gold, fontWeight: FontWeight.bold, fontSize: 13)),
                      ),
                    ]),
                    const SizedBox(height: 20),

                    // ── Footer tagline ──────────────────────────────────────────
                    Text('CulturaX · Smart Cultural Ecosystem',
                        textAlign: TextAlign.center,
